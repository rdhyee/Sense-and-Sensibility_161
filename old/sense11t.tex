...
% dark red
\definecolor{gcolor}{cmyk}{0,0.89,0.94,0.5}
% if color is not desired, comment out above line and
% use next line instead (to define black as the emphasis color)
...
\usepackage[papersize={5.25in,8.0in},%
  left=0.48in,right=0.48in,%
  top=0.2in,bottom=0.5in,%
  head=0.2in,headsep=0.25in,foot=0.35in,%
  twosideshift=0in,dvips]{geometry}
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancypagestyle{plain}{%
  \fancyhf{}%
  \fancyfoot[C]{\textcolor{gcolor}{\thepage}}%
  \renewcommand{\headrulewidth}{0pt}%
  \renewcommand{\footrulewidth}{0pt}}
\newcommand{\thetitle}{}
\newcommand{\theauthor}{}
\fancyfoot[C]{\textcolor{gcolor}{\thepage}}
\fancyhead[CE]{\textcolor{gcolor}{\small\textsc{\so{Sense and Sensibility}}}}
\fancyhead[CO]{\textcolor{gcolor}{\small\textsc{\so{Jane Austen}}}}
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\footrulewidth}{0pt}
\sloppy
\makeatletter
\renewcommand{\section}{\@startsection{section}%
  {0}{0in}{1.8\baselineskip}{1.3\baselineskip}%
  {\large\centering\itshape\bfseries\textcolor{gcolor}}}
\makeatother
...
\newcommand{\gtitle}[1]{%
  \renewcommand{\thetitle}{#1}\begin{center}{\Large\bf #1}\end{center}\medskip}
\newcommand{\gauthor}[1]{%
  \renewcommand{\theauthor}{#1}\begin{center}{\large #1}\end{center}\vspace{0.3in}}
\newcommand{\gdash}{{---}{---}}
\newcommand{\gintro}[1]{\textcolor{gcolor}{\textsc{#1}}}
% if small-caps intro phrases are not desired, comment out above
% line and use next line instead
